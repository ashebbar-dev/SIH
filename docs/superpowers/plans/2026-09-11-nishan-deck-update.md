# NISHAN Deck Update Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Update the existing six-slide NISHAN PPT and matching PDF with corrected measured evidence and unresolved limitations.

**Architecture:** Retain the existing template-based python-pptx builder. Add a small deck-specific evidence/notes module, revise slide content, and align the verifier and focused tests. No prototype behavior changes.

**Tech Stack:** Existing Python virtual environment, python-pptx, PyMuPDF, LibreOffice, unittest.

**Spec:** research/NISHAN_DECK_UPDATE_SPEC_2026-09-11.md
